...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Inter', sans-serif; }
        ...
        /* 🔥 修复1：加大卡片最大宽度 (950px -> 1400px)，利用屏幕空间，消灭滚动条 */
        .chart-card { background: white; width: 98%; max-width: 1400px; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.1); padding-bottom: 20px; }
        ...
        /* 🔥 修复2：表格宽度适配，移除过大的 min-width */
        table { width: 98%; margin: 0 auto; border-collapse: separate; border-spacing: 0 8px; font-size: 14px; min-width: 100%; }
        ...
        /* 🔥 修复3：描述列改为 120px */
        .desc-col { width: 120px; padding: 2px !important; }
...
<body>
    ...
    function adjustNameFontSize() {
        const containers = document.querySelectorAll('.name-container'); const maxWidth = 90; 
