...
class SkinSystem:
    ...
    def generate_html(self):
        # 🔥 V19.44 界面回归：使用 V19.39 比例 (initial-scale=0.75, zoom=0.85)，并强制开启滑动
        html_template = """
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Inter', sans-serif; }
        ...
        table { width: 98%; margin: 0 auto; border-collapse: separate; border-spacing: 0 8px; font-size: 14px; min-width: 650px; }
        ...
        td { padding: 12px 4px; vertical-align: middle; text-align: center; background-color: transparent; border: none; white-space: nowrap; }
